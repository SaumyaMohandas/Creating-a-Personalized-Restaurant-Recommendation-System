...
API_KEY = "gJR1S3919hu9So7sis7H09hL2aS0tbFQwHvCUFtl3kka"
...
def keywords():
    ...
    payload_scoring = {"input_data": [{"field": [["Malabar Bay"]], "values": [(input_features)]}]}
    response_scoring = requests.post('https://eu-gb.ml.cloud.ibm.com/ml/v4/deployments/24692b94-71ec-4cce-8b78-98aa69562845/predictions?version=2022-06-25', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
